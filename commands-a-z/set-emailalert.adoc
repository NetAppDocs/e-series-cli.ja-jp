...
このコマンドは、E4000、E2800、E5700、EF600、EF300、EF50、およびEF80ストレージアレイに適用されます。ただし、E2700またはE5600アレイの場合、このコマンドはスクリプトコマンドではなく、SMcliコマンドとして使用できます。この場合、このコマンドは管理ドメイン内のすべてのアレイに適用されます。
