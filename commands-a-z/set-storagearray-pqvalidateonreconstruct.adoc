...
summary: セットstorageArray pqValidateOnReconstructコマンドは、再構築時にストレージアレイのP/Q検証状態を設定します。この機能が有効になっている場合、データPとデータQの両方を使用してデータが再構築され、処理方法を決定する前に結果の一貫性がチェックされます。 
---
...
E4000、2800、E5700、EF600、EF300、EF50、またはEF80ストレージアレイでこのコマンドを実行するには、Storage Adminロールが必要です。
