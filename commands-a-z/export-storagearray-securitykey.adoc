...
外部キー管理が有効になっている場合、このコマンドはE4000、E2800、E5700、EF600、EF300、EF50、およびEF80アレイにのみ適用されます。内部キー管理が有効になっている場合、すべてのSMcliパッケージがインストールされていれば、このコマンドは個々のストレージアレイに適用されます。
