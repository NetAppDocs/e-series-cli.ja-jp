...
---
= スナップショットグループリポジトリボリューム容量の設定 - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
このコマンドは、すべての SMcli パッケージがインストールされている限り、E4000、2700、E5600、E2800、E5700、EF600、EF300、EF50、および EF80 アレイを含む、あらゆる個々のストレージアレイに適用されます。
