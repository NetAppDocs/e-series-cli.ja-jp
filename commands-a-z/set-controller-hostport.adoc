...
summary: セットコントローラーhostPortコマンドは、iSCSI、iSER、NVMe over InfiniBand、およびNVMe over RoCEのホストポートタイプのネットワークプロパティを変更します。プロパティの変更には、IPv4およびIPv6プロパティ、ポート速度、および最大フレームペイロードが含まれます。 
---
